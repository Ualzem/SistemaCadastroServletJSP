 ...
 */
@MultipartConfig       // ESSA NOTAÇÃO PERMITE ENVIAR DADOS EM TEXTO E UPLOADS PARA O BANCO
...
public class Usuario extends HttpServlet {
		...
		try {
			...
			if (ServletFileUpload.isMultipartContent(request)){
				...
				if (imagemFoto != null && imagemFoto.getInputStream().available() > 0) {
					...
					// INÍCIO MINIATURA DE IMAGEM
					
					// 1º TRANSFORMAR EM bufferedImage:
					...
					// 4º ESCREVER A IMAGEM NOVAMENTE:
			...
			// FIM CÓDIGO FILE UPLOAD DE IMAGENS E PDF
			...
			if(login == null || login.isEmpty()) {
				msg = "Login deve ser informado!!!";  // VALIDAR SE CAMPO LOGIN FOI PREENCHIDO OU NÃO
				podeInserir = false;
			}
			
			
			else if(senha == null || senha.isEmpty()) {
				msg = "A Senha deve ser informada!!!";  // VALIDAR SE CAMPO SENHA FOI PREENCHIDO OU NÃO
				podeInserir = false;
			}
			
			
			else if(nome == null || nome.isEmpty()) {
				msg = "O nome deve ser informado!!!";  // VALIDAR SE CAMPO NOME FOI PREENCHIDO OU NÃO
				podeInserir = false;
			}
			
			//else if(telefone == null || telefone.isEmpty()) {
			//	msg = "O telefone deve ser informado!!!";  // VALIDAR SE CAMPO TELEFONE FOI PREENCHIDO OU NÃO
			//	podeInserir = false;
			//}
	...
	// MÉTODO QUE CONVERTE A ENTRADA DE FLUXO DE DADOS DA IMAGEM P 1 ARRAY[] DE BYTE:
