...
<a  href="index.jsp"><img alt="Início" src="resources/img/homeIcon.png" widht="50px" height="50px" title="Home"></a>
	...
	<center><h1>Cadastro de Novo Produto:</h1>
		...
		<ul class="form-style-1">
			<li>
				<table>
					...
					<tr>
						<td>Nome:</td>
						<td><input type="text" id="nome" name="nome" style="width:400px"
							value="${produto.nome}" maxlength="50"></td>
					</tr>
					...
					<tr>
						...
						data-precision="2" value="${produto.valorEmTexto}" maxlength="20"></td>
					</tr>
					...
					<c:forEach items="${categorias}" var="cat">    <!-- USAMOS O c:forEach AQUI PORQUE OS ITEM A SEREM CARREGADOS SÃO DINÂMICOS -->
					...
					onclick="document.getElementById('formUser').action = 'salvarProduto?acao=reset'"></td><!-- BOTÃO CANCELAR  -->
                    </tr>
				</table> 
			</li>
		</ul>
	...
	<th>EDITAR</th>
		...
		<c:forEach items="${produtos}" var="produto">
			<tr>
				...
				<td style="font-size: 18px;"><c:out value="${produto.quantidade}"></c:out></td>
				<td style="font-size: 18px;"><c:out value="${produto.categoria_id}"></c:out></td>
				...
				<td style="font-size: 18px;"><fmt:formatNumber type="number" maxFractionDigits="2" value="${produto.valor}"/></td>
				<td style="font-size: 18px;"><fmt:formatNumber type="number" maxFractionDigits="2" value="${produto.valor * produto.quantidade}"/></td>

                   <!-- fmt - EXTENSÃO JSP PARA NUMEROS. URL COLOCADA LÁ EM CIMA -->

				<td><a href="salvarProduto?acao=delete&produto=${produto.id }">
				<img src="resources/img/ExcluirIcon.png" widht="32px" height="32px" title="Excluir"></a></td>
				<!-- LINK DE EXCLUIR REGISTRO -->
				<td ><a href="salvarProduto?acao=editar&produto=${produto.id }">
				<img src="resources/img/EditarIcon.png" widht="32px" height="32px" title="Editar"></a></td>
