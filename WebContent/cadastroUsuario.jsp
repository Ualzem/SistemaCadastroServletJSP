...
<a  href="index.jsp"><img alt="Início" src="resources/img/homeIcon.png" widht="50px" height="50px" title="Home"></a>
	...
	<center><h1>Cadastro de Novo Usuário:</h1>
	<h3 style="color:red" > ${msg} </h3>
	</center>
	
	

	<form action="salvarUsuario" method="post" id="formUser"  onsubmit= "" enctype="multipart/form-data" >
		...
		<ul class="form-style-1">
			<li>
				<table>
					...
					<tr>
						...
						<td>CEP::</td>
						<td><input name="cep" type="text" id="cep"  onblur="consultaCEP();" 
						 value="${user.cep}"/></td>	
					...
					<tr>
						<td>Login:</td>
						<td><input type="text" id="login" name="login" placeholder="crie o seu login" maxlength="10"
							value="${user.login}"></td>
							
							<td>Rua::</td>
						<td><input name="rua" type="text" id="rua" value="${user.rua}" maxlength="50"/></td>
					...
					<tr>
						<td>Senha:</td>
						<td><input type="password" id="senha" name="senha" placeholder="crie sua senha"
							value="${user.senha}" maxlength="8"></td>
							
							<td>Bairro::</td>
						<td><input name="bairro" type="text" id="bairro" value="${user.bairro}" maxlength="30"/></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" id="nome" name="nome"
							...
							<td>Cidade::</td>
						<td><input name="cidade" type="text" id="cidade" value="${user.cidade}" maxlength="50"/></td>
					</tr>
					...
					<tr><div class="form-group">
						<td>Telefone:</td>
						<td><input name="telefone" type="text" id="telefone" data-mask="(00) 00000-0000" value="${user.telefone}" /></td>
						</div>
						<td>Estado::</td>
						<td><input name="estado" type="text" id="estado" value="${user.estado}" maxlength="22"/></td>
					</tr>
					...
					<tr>
						...
						<td>IBGE::</td>
						<td><input name="ibge" type="text" id="ibge" value="${user.ibge}" maxlength="20"/></td>
					...
					<tr>                                
						...
						<td>Sexo:</td>   <td><input type= "radio" name="sexo"
						...
						%>
						 ...
						 <td>Foto:</td>
			<td>
			<input type="file" name="foto"><!-- CSS INLINE PARA ESCONDER O TYPE(style="display:none;") -->
			</td>
			...
			<input type="file" name="curriculo" value="Curriculo">
				...
				<!-- NA PASTA WebContent/WEB-INF/lib FOI ADICIONADO 2 BIBLIOTECAS PARA UPLOAD DE ARQUIVOS -->	
					...
					onclick="document.getElementById('formUser').action = 'salvarUsuario?acao=reset'"></td><!-- BOTÃO CANCELAR  -->
                    </tr>
				</table> 
			</li>
		</ul>
	...
	<th>EDITAR</th>
		...
		<c:forEach items="${usuarios}" var="user">
			<tr>
				...
				<c:if test= "${user.fotoBase64Miniatura.isEmpty() == false }"> <!-- SE NÃO ESTÁ VAZIO MOSTRA ICONE FOTO -->
				...
				<td> <img  src= "resources/img/UserPadrao.png" alt= "Image User" widht="32px" height="32px"
				...
				<img src= "resources/img/PDFicon.png" alt= "Currículo" widht="32px" height="32px"></a></td>
				</c:if>
				
				<c:if test= "${user.curriculoBase64 == null }">
				<td><img src= "resources/img/semPDFicon.png" alt= "Currículo" widht="32px" height="32px"
				...
				<img src="resources/img/phone.png" alt="Telefones" widht="32px" height="32px" title="Telefones"></a></td>
				<!-- LINK DE EDITAR O TELEFONE -->
				

				<td><a href="salvarUsuario?acao=delete&user=${user.id }">
				<img src="resources/img/ExcluirIcon.png" alt="Excluir" widht="32px" height="32px" title="Excluir"
				...
				<img src="resources/img/EditarIcon.png" alt="Editar" widht="32px" height="32px" title="Editar"></a></td>
